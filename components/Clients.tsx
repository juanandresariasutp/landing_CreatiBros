...
export function Clients() {
  ...
  return (
    <section id="clientes" className="py-20 bg-cb-lavender-light/20 border-y border-cb-lavender-light/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h3 className="text-center font-arsenica text-2xl md:text-3xl font-bold text-cb-navy mb-12">
        ...
        <div className="overflow-hidden cursor-grab active:cursor-grabbing" ref={emblaRef}>
          <div className="flex">
            {clientLogos.map((logo) => (
              ...
              >
                <div className="relative h-20 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
                  <Image
