    ...
    <div className="mb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-8">
          <div>
            <h3 className="font-arsenica text-3xl font-bold text-cb-dark dark:text-cb-white">{title}</h3>
          ...
          <div className="hidden sm:flex gap-3">
            <button
              onClick={scrollPrev}
              className="w-10 h-10 rounded-full border border-cb-lavender-med dark:border-cb-white/20 flex items-center justify-center text-cb-dark dark:text-cb-white hover:bg-cb-lavender-light dark:hover:bg-cb-white/10 transition-colors"
            >
